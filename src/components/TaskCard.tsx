...
function TaskCard({ task, deleteTask, updateTask }: Props) {
  ...
  if(isDragging){
    ...
    flex text-left rounded-xl border-rose-500 cursor-grab
    relative"
    />
    );
}
  ...
  if (editMode) {
    ...
    hover:ring-2 hover:ring-inset hover:ring-rose-500 cursor-grabs
    relative"
      >
        <textarea
          className="
  ...
  relative"
    ...
    >
      ...
      -translate-y-1/2 bg-columnBackgroundCol p-2 rounded
